        <div class="row">
            <div class="col-lg-6">
              ...
              <div class="card mb-4">
                ...
                <div class="card-body">        
                <form action="<?= base_url('admin/addroti'); ?>" method="post">
                  <div class="form-group">
                    <label for="select2SinglePlaceholder">Nama Roti</label>
                    <input class="form-control  mb-3" type="text" name="nama_roti" placeholder="Nama roti">
                  ...
                  <div class="form-group" id="simple-date1">
                    <label for="simpleDataInput">Tanggal</label>
                      <div class="input-group date">
                        ...
                        <input type="text" class="form-control" name="tanggal" value="<?= date('Y-m-d');?>" id="simpleDataInput">
